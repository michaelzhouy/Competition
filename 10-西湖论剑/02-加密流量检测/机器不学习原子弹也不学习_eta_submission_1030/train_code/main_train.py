...
def train_func(train_path):
    ...
    used_cols = ['srcPort', 'srcAddressPort_gp_destAddress_nunique_rate', 'srcAddress_bytesOut_max', 'srcAddress_bytesOut_min', 'srcAddress_bytesOut_median', 'srcAddress_bytesOut_std', 'srcAddress_bytesIn_min', 'srcAddress_bytesIn_skew', 'srcAddress_bytesIn_std', 'srcAddress_pktsIn_skew', 'srcAddress_pktsOut_mean', 'srcAddress_pktsOut_skew', 'destAddress_bytesOut_min', 'destAddress_bytesIn_max', 'destAddress_bytesIn_median', 'destAddress_pktsIn_sum', 'destAddress_pktsOut_quantile_25', 'tlsVersion_bytesOut_min', 'tlsVersion_bytesOut_skew', 'tlsSubject_bytesOut_sum', 'tlsSubject_bytesOut_std', 'tlsSubject_bytesOut_nunique', 'tlsSubject_bytesOut_quantile_25', 'tlsSubject_bytesIn_max', 'tlsSubject_bytesIn_min', 'tlsSubject_bytesIn_std', 'tlsSubject_bytesIn_max_min', 'tlsSubject_bytesIn_quantile_25', 'tlsSubject_pktsIn_max', 'tlsSubject_pktsIn_mean', 'tlsSubject_pktsIn_quantile_25', 'tlsSubject_pktsOut_skew', 'tlsSubject_pktsOut_max_min', 'tlsSubject_pktsOut_quantile_25', 'tlsIssuerDn_bytesOut_min', 'tlsIssuerDn_bytesOut_std', 'tlsIssuerDn_bytesOut_quantile_25', 'tlsIssuerDn_bytesOut_quantile_75', 'tlsIssuerDn_bytesIn_median', 'tlsIssuerDn_bytesIn_skew', 'tlsIssuerDn_bytesIn_std', 'tlsIssuerDn_bytesIn_quantile_25', 'tlsIssuerDn_pktsIn_min', 'tlsIssuerDn_pktsIn_mean', 'tlsIssuerDn_pktsIn_sum', 'tlsIssuerDn_pktsIn_skew', 'tlsIssuerDn_pktsIn_nunique', 'tlsIssuerDn_pktsIn_quantile_25', 'tlsIssuerDn_pktsIn_quantile_75', 'tlsIssuerDn_pktsOut_skew', 'tlsIssuerDn_pktsOut_std', 'tlsIssuerDn_pktsOut_nunique', 'tlsIssuerDn_pktsOut_max_min', 'tlsIssuerDn_pktsOut_quantile_75', 'tlsSni_bytesOut_min', 'tlsSni_bytesOut_median', 'tlsSni_bytesOut_nunique', 'tlsSni_bytesOut_max_min', 'tlsSni_bytesOut_quantile_25', 'tlsSni_bytesIn_max', 'tlsSni_bytesIn_median', 'tlsSni_bytesIn_mean', 'tlsSni_bytesIn_sum', 'tlsSni_bytesIn_std', 'tlsSni_bytesIn_quantile_25', 'tlsSni_bytesIn_quantile_75', 'tlsSni_pktsIn_min', 'tlsSni_pktsIn_median', 'tlsSni_pktsIn_mean', 'tlsSni_pktsIn_skew', 'tlsSni_pktsIn_quantile_25', 'tlsSni_pktsOut_max', 'tlsSni_pktsOut_nunique', 'tlsSni_pktsOut_max_min', 'destAddressPort_pktsOut_mean', 'bytesOut_pktsInc_multiply', 'bytesOut_pktsOut_subtract', 'bytesIn_pktsIn_subtract', 'bytesIn_pktsOut_add', 'bytesIn_pktsOut_subtract', 'pktsIn_pktsOut_subtract', 'bytesIn_bytesOut_ratio', 'pktsIn_pktsOut_ratio', 'pktsOut_pktsIn_ratio']

    y = train['label']
    train = train[used_cols]

    all_dataset = lgb.Dataset(train, y)
