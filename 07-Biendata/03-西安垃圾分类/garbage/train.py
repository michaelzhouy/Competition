...
from utils.prepare_data import load_data, split_data
...
def main():
    ...
    # Data
    data_dir = '../data/'
    train_data, test_data = load_data(data_dir=data_dir)
    train_df, valid_df = split_data(train_data, test_size=1000)
...
def train(train_loader, model, criterion, optimizer, epoch, use_cuda):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        # print('shape: ', targets.shape, outputs.shape)
